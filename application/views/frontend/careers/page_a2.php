<div class="float_container" data-page-name="a2">
    ...
    <div class="wrap">
        ...
        <div class="info">
            <h1 class="title">
                <?=$translg->$langkey->careers->item->app->title?>
            </h1>
            ...
            <p class="date">
                <?=$translg->$langkey->careers->item->app->date?>
            </p>
            
            <p class="desc">
                <?=$translg->$langkey->careers->item->app->content?>
            </p>
        </div>
        ...
        <div class="resplist">
            <div class="item">
                ...
                <ul>
                    <?=$translg->$langkey->careers->item->app->responsibilities?>
                </ul>
            </div>
            <div class="item">
                <h2 class="title"><?=$translg->$langkey->careers->requirements?>:</h2>
                <ul>
                    <?=$translg->$langkey->careers->item->app->requirements?>
                </ul>
            </div>
        </div>
