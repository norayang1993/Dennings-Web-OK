<div class="container ">
    ...
    <div class="itembox" id="BC">
        ...
        <article>
            ...
            <p class="content">
                <?=$translg->$langkey->services->BC->content?>
            </p>
    ...
    <div class="itembox" id="RLIH">
        ...
        <article>
            ...
            <p class="content">
                <?=$translg->$langkey->services->RLIH->content?>
            </p>
            <footer class="btblock">
                <button class="more">See More</button>
            </footer>
    ...
    <div class="itembox" id="RSP">
        ...
        <article>
            ...
            <p class="content">
                <?=$translg->$langkey->services->RSP->content?>
            </p>
            <footer class="btblock">
                <button class="more">See More</button>
            </footer>
    ...
    <div class="itembox" id="TOB">
        ...
        <article>
            ...
            <p class="content">
                <?=$translg->$langkey->services->TOB->content?>
            </p>
            <footer class="btblock">
                <button class="more">See More</button>
            </footer>
    ...
    <div class="itembox" id="IPPO">
        ...
        <article>
            ...
            <p class="content">
                <?=$translg->$langkey->services->IPPO->content?>
            </p>
            <footer class="btblock">
                <button class="more">See More</button>
            </footer>
