<div class="page a2" >
    ...
    <p>
        Your use of the Dennings Service is also subject to the Dennings Privacy Policy in effect at the time of your use, which is incorporated herein. You can review the most current version of the Dennings Privacy Policy at this website.
    </p>
    ...
    <p>
        Dennings may preserve your Content and may also disclose such Content, with or without notice to you, if required to do so by law or in the good faith belief that such preservation or disclosure is reasonably necessary to: <br>
        comply with legal process; <br>
        enforce these Terms of Service;<br>
        respond to claims that your Content violates the rights of any third party; or<br>
    ...
    <p>
        Dennings will use common and business sense regarding Content or behavior allowed on or through the Dennings Service. Examples of unacceptable Content or behaviour include:<br>
        Abuse, harassment, threats, flaming or intimidation of any person or organization.<br>
        Engaging in or contributing to any illegal activity or activity that violates others’ rights.<br>
        Use of derogatory, discriminatory or excessively graphic language.<br>
        Providing information that is false, misleading or inaccurate.<br>
        Hacking or modifying the Dennings Service or another website to falsely imply an association with Dennings.<br>
        Implying or pretending to be affiliated with a company or organization with which you are not affiliated, or misrepresenting the extent of your affiliation or role with an affiliated company or organization.<br>
        Transmitting worms, viruses or harmful software.<br>
        Sending unwanted messages or spam to other users.<br>
        Disclosing personal or proprietary information of another person or organization.<br>
        Interfering with or disrupting the Dennings Service or servers or networks connected to the Dennings Service.<br>
    ...
    <p>
        ...
        Identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit Dennings to locate the material.<br>
        Complete URLs or link or saved image for each instance of the allegedly infringing material.<br>
        Contact Information.<br>
        Your confirmation that use of the material in the manner complained of is not authorized by the copyright owner, its agent, or the law.<br>
    ...
    <h2>ADDITIONAL TERMS APPLICABLE ONLY TO CLIENTS</h2>
    ...
    <p>
        We may, in our sole discretion and with or without notice, vary, modify or discontinue the Dennings Service or any part of them without notice. <br>
        You acknowledge that: <br>
        The information on the Dennings Service, in particular our applications and Website are provided to you on an “As Is” and “As Available” basis, without warranty or condition, either express or implied by statute or common law, including without limitation any implied warranties or conditions of accuracy, fitness for a particular purpose, non-infringement, uninterrupted use, reliability, security, timeliness or freedom from computer virus in relation to such contents. We will not be liable for any errors in, omissions from, misstatements or misrepresentations (whether express or implied) concerning any such information. <br>
        The Dennings Service may contain materials contributed by third parties and link to external website. We expressly declare that we have not approved or endorsed those materials or links. Such external websites are not within our control and may not follow the same privacy, security, or accessibility standards as ours. The provision of any such materials or links shall not constitute any form of cooperation or affiliation with us of any such third parties or external websites nor gives rise to any representation, statement or warranty, express or implied, that we agree or do not disagree with the contents of any such materials or external websites. <br>
        We will not have or accept any liability, obligation or responsibility whatsoever for any loss, destruction or damage (including without limitation consequential loss, destruction or damage) however arising from or in respect of any use or misuse of or reliance on the information delivered on the Dennings Service or inability to use any of the Dennings Service. <br>
    </p>

    <p>
        We make no representation, promise, warranty, undertaking or guarantee as to the quality, resolution, completeness, accuracy, usefulness, continuity, smoothness or timeliness of the Dennings Service. <br>
        Nothing you do on or in relation to the Dennings Service will transfer any intellectual property rights to you or license you to exercise any intellectual property rights. <br>
    </p>
    ...
    <h2>LINKS AND ADVERTISEMENTS</h2>
